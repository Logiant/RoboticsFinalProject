...
static real_T c2_mpower(SFc2_wheel2InstanceStruct *chartInstance, real_T c2_a,
  real_T c2_b);
static void c2_eml_scalar_eg(SFc2_wheel2InstanceStruct *chartInstance);
static void c2_eml_error(SFc2_wheel2InstanceStruct *chartInstance);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_wheel2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_wheel2InstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_wheel2, const char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_wheel2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
  ...
  const mxArray *c2_st)
{
  ...
  *c2_td = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
    "td");
  chartInstance->c2_is_active_c2_wheel2 = c2_d_emlrt_marshallIn(chartInstance,
